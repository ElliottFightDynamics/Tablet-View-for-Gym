...
public class CurveChartView extends View{
    ...
    private void init(){
        ...
        borderPaint.setColor(mContext.getResources().getColor(R.color.curve_border));
        ...
        curvePaint.setColor(mContext.getResources().getColor(R.color.force_text_color));
        curvePaint.setAntiAlias(true);
        curvePaint.setAlpha(200);

        fillPaint.setStyle(Paint.Style.FILL);
        fillPaint.setColor(mContext.getResources().getColor(R.color.force_text_color));
        ...
        tipLinePaint.setColor(mContext.getResources().getColor(R.color.punches_text_color));
    ...
    public void changeGraph(boolean isSpeed){
        ...
        if (!isSpeed){
            ...
            curvePaint.setColor(mContext.getResources().getColor(R.color.speed_text_color));
            curvePaint.setAlpha(130);
            fillPaint.setColor(mContext.getResources().getColor(R.color.speed_text_color));
            fillPaint.setAlpha(130);
        }
        ...
        if (!isSpeed){
            scaleY = (float)chartHeight / EFDConstants.POWER_MAX;
        }else
            scaleY = (float)chartHeight / EFDConstants.SPEED_MAX;
