...
public class QuickstartTrainingPresetFragment extends Fragment {
    ...
    public static QuickstartTrainingPresetFragment trainingPresetFragment;

    public static Fragment newInstance(Context context, String type) {
        mContext = context;
        trainingPresetFragment = new QuickstartTrainingPresetFragment();
