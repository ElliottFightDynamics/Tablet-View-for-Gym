...
import com.efd.striketectablet.DTO.DBTrainingDataDTO_OLD;
import com.efd.striketectablet.DTO.DBTrainingDataDetailsDTO_OLD;
import com.efd.striketectablet.DTO.DBTrainingSessionDTO_OLD;
...
import com.efd.striketectablet.DTO.DBTrainingPunchDataDTO_OLD;
import com.efd.striketectablet.DTO.DBTrainingPunchDataPeakSummaryDTO_OLD;
...
import com.efd.striketectablet.DTO.SyncResponseDTO_OLD;
...
public class DBAdapter_OLD {
    ...
    private static final String TAG = "DBAdapter_OLD";
    ...
    private static final String DATABASE_NAME = EFDConstants.DATABASE_NAME_OLD;
...
//            + " total_time double DEFAULT NULL;";
    ...
    private static DBAdapter_OLD instance = null;
    private static String path = null;

    /**
     * A private Constructor for DBAdapter_OLD class prevents any other class from instantiating.
     *
     * @param ctx
     */
    private DBAdapter_OLD(Context ctx) {
        this.context = ctx;
    ...
    public static DBAdapter_OLD getInstance(Context ctx) {
        if (instance == null) {
            instance = new DBAdapter_OLD(ctx);
            instance.open();
        }
        return instance;
    }
...
//								resultJSON.put("success", false);
    ...
    public List<DBTrainingSessionDTO_OLD> getAllNonSynchronizedTrainingSessionRecords(int limit) {

        DBTrainingSessionDTO_OLD dbTrainingSessionDTO = null;
        List<DBTrainingSessionDTO_OLD> list = new ArrayList<DBTrainingSessionDTO_OLD>();
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                do {
                    dbTrainingSessionDTO = new DBTrainingSessionDTO_OLD(
    ...
    public List<DBTrainingDataDTO_OLD> getAllNonSynchronizedTrainingDataRecords(int limit) {

        DBTrainingDataDTO_OLD dbTrainingDataDTO = null;
        List<DBTrainingDataDTO_OLD> list = new ArrayList<DBTrainingDataDTO_OLD>();
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                while (cursor.isAfterLast() == false) {
                    dbTrainingDataDTO = new DBTrainingDataDTO_OLD(
    ...
    public List<DBTrainingDataDetailsDTO_OLD> getAllNonSynchronizedTrainingDataDetailsRecords(int limit) {

        DBTrainingDataDetailsDTO_OLD dbTrainingDataDetailsDTO = null;
        List<DBTrainingDataDetailsDTO_OLD> list = new ArrayList<DBTrainingDataDetailsDTO_OLD>();
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                while (cursor.isAfterLast() == false) {
                    dbTrainingDataDetailsDTO = new DBTrainingDataDetailsDTO_OLD(
                            cursor.getInt(0),
    ...
    public List<DBTrainingPunchDataDTO_OLD> getAllNonSynchronizedTrainingPunchDataRecords(int limit) {

        DBTrainingPunchDataDTO_OLD dbTrainingPunchDataDTO = null;
        List<DBTrainingPunchDataDTO_OLD> list = new ArrayList<DBTrainingPunchDataDTO_OLD>();
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                while (cursor.isAfterLast() == false) {
                    dbTrainingPunchDataDTO = new DBTrainingPunchDataDTO_OLD(
    ...
    public List<DBTrainingPunchDataPeakSummaryDTO_OLD> getAllNonSynchronizedTrainingPunchDataPeakSummaryRecords(int limit) {

        DBTrainingPunchDataPeakSummaryDTO_OLD dbTrainingPunchDataPeakSummary = null;
        List<DBTrainingPunchDataPeakSummaryDTO_OLD> list = new ArrayList<DBTrainingPunchDataPeakSummaryDTO_OLD>();
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                while (cursor.isAfterLast() == false) {
                    dbTrainingPunchDataPeakSummary = new DBTrainingPunchDataPeakSummaryDTO_OLD(
    ...
    public int updateSynchronizedRecordsForTable(String tableName, ArrayList<SyncResponseDTO_OLD> dtos) {
