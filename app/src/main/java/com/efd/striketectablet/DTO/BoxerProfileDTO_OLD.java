...
public class BoxerProfileDTO_OLD {
    private int boxerID;
    ...
    public BoxerProfileDTO_OLD(int boxerID, int boxerVersion, int chest,
    ...
    public String toString() {
        return "BoxerProfileDTO_OLD [boxerID=" + boxerID + ", boxerVersion="
