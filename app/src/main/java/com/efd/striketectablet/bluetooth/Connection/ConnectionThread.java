    ...
    public void run() {
        ...
        try {
            ...
            if (bluetoothSocket != null) {
                Log.i("ConnectionThread", EFDConstants.SENSOR_CONNECTION_ESTABLISHED_MESSAGE + "=" + bluetoothDevice.getAddress());
                String infoMsg = EFDConstants.SENSOR_CONNECTION_ESTABLISHED_MESSAGE + bluetoothDevice.getAddress();
                Message msg = uiHandler.obtainMessage(MainActivity.MESSAGE_TOAST);
                Bundle bundle = new Bundle();
                bundle.putString("TOAST", infoMsg);
                bundle.putString(EFDConstants.CONNECTED_DEVICE_TEXT, bluetoothDevice.getAddress());
            ...
            String infoMsg = EFDConstants.SENSOR_CONNECTION_FAILED_MESSAGE + bluetoothDevice.getAddress();
            Message msg = uiHandler.obtainMessage(MainActivity.MESSAGE_TOAST);
            Bundle bundle = new Bundle();
            bundle.putString("TOAST", infoMsg);
            ...
            ex.printStackTrace();
            String infoMsg = EFDConstants.BLUETOOTH_SOCKET_CONNECTION_FAILED_MESSAGE;
            Message msg = uiHandler.obtainMessage(MainActivity.MESSAGE_TOAST);
            Bundle bundle = new Bundle();
            bundle.putString("TOAST", infoMsg);
            bundle.putString("CONNECTION", "unsuccess");
