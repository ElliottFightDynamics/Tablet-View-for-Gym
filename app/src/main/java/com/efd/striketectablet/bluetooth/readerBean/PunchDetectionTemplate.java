...
public class PunchDetectionTemplate {
    ...
    public PunchDetectionTemplate() {
        ...
        try {
            ...
            Resources resources = StatisticUtil.getContext().getResources();
            AssetManager assetManager = resources.getAssets();

            // Read from the /assets directory
            InputStream inputStream = assetManager.open(EFDConstants.TEMPLATEFILEPATH);
    ...
    private int[] getXTemplate(String punchType) {
        ...
        if (punchType.equalsIgnoreCase(EFDConstants.HOOK)) {
            templateX[0] = this.getDx1Hook();
            templateX[1] = this.getDx2Hook();
        } else if (punchType.equalsIgnoreCase(EFDConstants.JAB) || punchType.equalsIgnoreCase(EFDConstants.STRAIGHT)) {
    ...
    private int[] getYTemplate(String punchType, String hand, String stance) {
        ...
        if (punchType.equalsIgnoreCase(EFDConstants.HOOK)) {
            if (hand.equalsIgnoreCase(EFDConstants.LEFT_HAND)) {
            ...
            if ((hand.equals(EFDConstants.LEFT_HAND)) /*stance.equals(EFDConstants.TRADITION) && hand.equals(EFDConstants.LEFT_HAND)) ||
    ...
    public static String getPropertiesfilepath() {
        return EFDConstants.TEMPLATEFILEPATH;
    }
