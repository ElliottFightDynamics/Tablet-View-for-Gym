...
public class CaldroidFragment extends DialogFragment {
    ...
    public static int disabledTextColor = Color.parseColor("#085A61");
    ...
    private RelativeLayout monthTitleBackground;
    ...
    public void refreshView() {
        ...
        // original code****monthTitleTextView.setText(new DateTime(year, month, 1, 0, 0).monthOfYear().getAsText().toUpperCase()+ " " + year);

        monthTitleTextView.setText(WordUtils.capitalizeFully(new DateTime(year, month, 1, 0, 0).monthOfYear().getAsText()).toString().toUpperCase() + ", " + year);        // changes by #1037
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        monthTitleBackground = (RelativeLayout) view.findViewById(R.id.calendar_title_view);
        ...
        if ((getResources().getConfiguration().screenLayout & Configuration.SCREENLAYOUT_SIZE_LARGE) == Configuration.SCREENLAYOUT_SIZE_LARGE || (getResources().getConfiguration().screenLayout & Configuration.SCREENLAYOUT_SIZE_XLARGE) == Configuration.SCREENLAYOUT_SIZE_XLARGE) {
            monthTitleTextView.setTextSize(30);
            monthTitleBackground.getLayoutParams().height = 90;
        } else {
            monthTitleBackground.getLayoutParams().height = 65;
        }
        ...
        weekdayGridView.setOnTouchListener(new OnTouchListener() {
    ...
    private ArrayList<String> getDaysOfWeek() {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            // original code****list.add(nextDay.dayOfWeek().getAsShortText().toUpperCase());

            list.add(WordUtils.capitalize(nextDay.dayOfWeek().getAsShortText()).toString());
